...
export default function ConfirmacionCompraPage() {
  ...
  const downloadInvoice = () => {
    ...
    doc.text("PowerFit", 105, 20, { align: "center" })
    ...
    doc.text("PowerFit S.A.C.", 140, 45)
    doc.text("RUC: 20123456789", 140, 52)
    doc.text("Av. Principal 123, Lima", 140, 59)
    doc.text("Teléfono: +51 123-456-789", 140, 66)
    ...
    doc.text("Gracias por tu compra en PowerFit.", 105, finalY + 50, { align: "center" })
